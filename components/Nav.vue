<template>
  <div v-on-clickaway="hideDropdown" class="z-50 antialiased bg-gray-100 dark-mode:bg-gray-900">
      ...
      <div class="flex flex-col max-w-screen-xl px-4 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
        ...
        >
          ...
          <div class="relative">
            ...
            >
              <div v-show="isOpen" class="absolute right-0 z-40 w-full mt-2 origin-top-right md:max-w-screen-sm md:w-screen">
                <div class="px-2 pt-2 pb-4 bg-white rounded-md shadow-lg dark-mode:bg-gray-700">
                  <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <a
                      class="flex flex-row items-start p-2 bg-transparent rounded-lg dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline"
                      href="#"
                    >
